...
TEMPLATE_SCHEMA = {
    "$schema": ""	,
    "$id": "https://eduscan.ai/schemas/template.json",
        ...
        "preProcessors": {
            ...
            "items": {
                ...
                "allOf": [
                    ...
                    {
                        "if": {"properties": {"name": {"const": "AdvancedFeatureAlignment"}}},
                        "then": {
                            "properties": {
                                "options": {
                                    "type": "object",
                                    ...
                                    "properties": {
                                        "reference": {"type": "string"},
                                        "featureType": {"type": "string", "enum": ["ORB", "AKAZE", "SIFT"]},
                                        "maxFeatures": {"type": "integer", "minimum": 100},
                                        "goodMatchPercent": {"type": "number", "minimum": 0.01, "maximum": 1.0},
                                        "resizeTemplate": {"type": "boolean"}
                                    },
                                    "required": ["reference"],
                                }
                            }
